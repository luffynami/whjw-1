...
var treeMenu = [
	{ level:1, name:"查询"},
	{ level:2, name:"查询个人信息", ico:"images/icon_default.gif",link:"business/query/QueryUserInfo.jsp"},
	{ level:2, name:"查询成绩", ico:"images/icon_default.gif",link:"business/query/QueryGrade.jsp"},
	{ level:2, name:"查询课表", ico:"images/icon_default.gif",link:"business/query/QueryTimeTable.jsp"},
